...
const create_player_card = (player_info_array, player_idx) => {
    ...
    username.textContent =
        "Username: " + player_info_array[player_idx].display_name;
    num_of_wins_div.textContent =
        "Number of Wins " + player_info_array[player_idx].num_wins;
    num_of_losses_div.textContent =
        "Number of Losses " + player_info_array[player_idx].num_loss;
